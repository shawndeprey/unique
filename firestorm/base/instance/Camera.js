...
Camera.prototype.set = function(options)
{
	...
	this.lastPosition = new Vec2({x: Firestorm.canvas.width / 2, y: Firestorm.canvas.height / 2});
...
Camera.prototype.xMovement = function(){
	return this.lastPosition.x - this.position.x;
}

Camera.prototype.yMovement = function(){
	return this.lastPosition.y - this.position.y;
}
